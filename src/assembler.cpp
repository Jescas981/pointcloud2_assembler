...
public:
  Assembler() : Node("assembler") {
    ...
    // Create subscriber
    cloud_sub_.subscribe(this, "/cloud_in");
    ...
    // Create service
    service_ = create_service<pointcloud2_assembler::srv::AssemblerQuery>(
        "assembler_service",
...
private:
  ...
  void handle_service(
      const std::shared_ptr<pointcloud2_assembler::srv::AssemblerQuery::Request> req,
      std::shared_ptr<pointcloud2_assembler::srv::AssemblerQuery::Response> res) {
...
private:
  ...
  rclcpp::Service<pointcloud2_assembler::srv::AssemblerQuery>::SharedPtr service_;
